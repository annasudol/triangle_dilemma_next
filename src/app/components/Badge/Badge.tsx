...
import { BadgeColourObject, BadgeProps, BadgeSizeObject } from '@/components/Badge/Badge.types';
...
const Badge: FC<BadgeProps> = ({
  ...
  return (
    <span
      className={clsx('inline-flex items-center rounded-full font-medium', pickedColor, pickedSize, additionalClasses)}
      {...props}
    >
      {link ? (
